...
public class GenereltView {
    ...
    public GenereltView(int valgtStue, ValgStueModel model) {
        ...
        TabelCitratmetabolismeController citratController = new TabelCitratmetabolismeController(citratModel,
                citratView);
        citratController.updateView(model.getCprNr());
        tablePanel.add(citratView.getTablePanel());
...
public class GenereltView {
    ...
    public GenereltView(int valgtStue, ValgStueModel model) {
        ...
        TabelCitratmetabolismeModel citratModel = new TabelCitratmetabolismeModel();
        TabelCitratmetabolismeView citratView = new TabelCitratmetabolismeView();
        TabelCitratmetabolismeController citratCtrl = new TabelCitratmetabolismeController(citratModel, citratView);
        citratCtrl.updateView(model.getCprNr());
